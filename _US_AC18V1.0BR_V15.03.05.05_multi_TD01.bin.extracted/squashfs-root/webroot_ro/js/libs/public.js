...
R.extend(R, {
	...
	isTimeOut: function (str) {
		if (str.indexOf("<!DOCTYPE html") === 0 && str.indexOf("login.js?26753faa15e908b7272147d75c2e21c4") != -1) {
			return true;
		}
...
function translateDeviceType(str) {
	...
	if (top.G.deviceList.indexOf(str) != -1) {
		...
		//设备未支持的手机图标
		obj = {
			src: "./img/device/others.png?26753faa15e908b7272147d75c2e21c4",
			exsit: false,
