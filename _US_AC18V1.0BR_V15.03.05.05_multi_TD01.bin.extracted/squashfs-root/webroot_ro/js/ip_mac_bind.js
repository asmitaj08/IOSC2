...
function hideEditNameArea(rowEle, devName) {
    $(rowEle).find(".dev-name").text(devName).append('<img class="edit-btn none edit-btn-txt-append" src="img/edit.png?26753faa15e908b7272147d75c2e21c4" />');
}
...
function addList() {
    ...
    str += "<tr>";
    str += "<td class='dev-name fixed edit-td' title='" + "'><span class='dev-name-txt dev-target'>" + "</span><img class='edit-btn none edit-btn-txt-append' src='img/edit.png?26753faa15e908b7272147d75c2e21c4' /></td>";
