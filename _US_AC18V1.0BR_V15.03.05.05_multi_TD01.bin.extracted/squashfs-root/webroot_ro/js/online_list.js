...
function createOnlineList(initDataList, localhostMac) {
	...
	for (i = 0; i < initDataList.length; i++) {
		...
		str += "<div class='online-device-content'><div class='dev-name text-fixed' style='padding-right: 30px;'><span class='dev-name-txt'></span><img class='edit-btn edit-btn-txt-append' src='img/edit_new.png?26753faa15e908b7272147d75c2e21c4' style='width:14px;height:14px;' /></div><div class='txt-help-tips font-txt-small' data-alt='ip'>" + initDataList[i].ip + "</div></div></td>";
...
function hideEditNameArea(rowEle, devName) {
	$(rowEle).find(".dev-name").text(devName).append('<img class="edit-btn edit-btn-txt-append" src="img/edit_new.png?26753faa15e908b7272147d75c2e21c4" style="width:14px;height:14px;"/>');
}
	...
	for (i = 1; i < len; i++) {
		...
		if ($trDom.length === 1) {
			...
			str = "<tr alt='" + obj[i].deviceId + "' class='tr-row device-target'>" +
				"<td class='edit-td'><div class='device-icon'><img src='" + deviceType.src + "'>" + showDeviceLogoString(deviceType, obj[i].linkType) + "</div><div class='online-device-content'><div class='dev-name text-fixed' style='padding-right: 30px;'><span class='dev-name-txt'></span><img class='edit-btn edit-btn-txt-append' src='img/edit_new.png?26753faa15e908b7272147d75c2e21c4' style='width:14px;height:14px;' /></div>" +
