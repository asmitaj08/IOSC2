...
function hideEditNameArea(rowEle, devName) {
	$(rowEle).find(".dev-name").text(devName).attr("title", devName).append('<img class="edit-btn edit-btn-txt-append" src="img/edit_new.png?26753faa15e908b7272147d75c2e21c4" style="width:14px;height:14px;"/>');
}
...
function addRow(obj) {
	...
	str += "<td class='edit-td'><div class='device-icon'><img src='" + deviceType.src + "'>" + showDeviceLogoString(deviceType, obj.devType) + "</div><div class='online-device-content'><div class='dev-name text-fixed' style='padding-right: 30px;'><span class='dev-name-txt'></span><img class='edit-btn edit-btn-txt-append' src='img/edit_new.png?26753faa15e908b7272147d75c2e21c4' style='width:14px;height:14px;' /></div><div class='txt-help-tips'>" + (obj.ip || "---") + "</div></div></td>";
